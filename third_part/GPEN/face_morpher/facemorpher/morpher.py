...
::
  ...
  Options:
    ...
    --width=<width>         Custom width of the images/happy_level2 [default: 500]
    --height=<height>       Custom height of the images/happy_level2 [default: 600]
    --num=<num_frames>      Number of morph frames [default: 20]
    --fps=<fps>             Number frames per second for the happy_level2 [default: 10]
    --out_frames=<folder>   Folder path to save all image frames
    --out_video=<filename>  Filename to save a happy_level2
